...
const TourCard = ({ image, title, days, price, tag }) => (
...
  const carouselRef = useRef(null);
  ...
  const toursData = [
    { id: 1, image: quba, title: "Quba Mountain", days: "2 days / 1 night", price: "180 azn", tag: "Mountain Tour" },
    { id: 2, image: goygol, title: "Lake Goygol", days: "2 days / 1 night", price: "99 azn", tag: "Lake Tour" },
    { id: 3, image: baku, title: "Baku, Azerbaijan", days: "1-5 days", price: "50 azn", tag: "City Tour" },
    { id: 4, image: qobustan, title: "Qobustan", days: "8 hours", price: "79 azn", tag: "Historical" },

    { id: 5, image: quba, title: "Quba Valley Tour", days: "2 days / 1 night", price: "180 azn", tag: "Mountain Tour" },
    { id: 6, image: goygol, title: "Absheron Drylands", days: "2 days", price: "36 azn", tag: "Dry Tour" }, 
    { id: 7, image: baku, title: "Old City & Flame Towers", days: "1-5 days", price: "50 azn", tag: "City Tour" },
    { id: 8, image: qobustan, title: "Qobustan & Mud Volcanoes", days: "8 hours", price: "79 azn", tag: "Historical" },
    
    { id: 9, image: quba, title: "Shahdag Ski Resort", days: "3 days / 2 night", price: "250 azn", tag: "Mountain Tour" },
    { id: 10, image: goygol, title: "Goygol National Park", days: "1 day", price: "65 azn", tag: "Lake Tour" },
    { id: 11, image: baku, title: "Baku Night Life", days: "2 days", price: "80 azn", tag: "City Tour" },
    { id: 12, image: qobustan, title: "Atəşgah & Yanar Dağ", days: "4 hours", price: "40 azn", tag: "Historical" },
  ];
  ...
  const handleScroll = () => {
    if (carouselRef.current) {
        ...
        const activePage = Math.min(Math.floor(cardPosition / CARDS_PER_PAGE) + 1, totalPages);
...
          <label htmlFor="sort-price" className="dropdown-label">Sort by price</label>
...
      <main className="tours-carousel" ref={carouselRef} onScroll={handleScroll}>
        {toursData.map((tour) => (
            <TourCard
              key={tour.id}
              image={tour.image}
